...
download.file('https://bit.ly/de-cities-distance', t, mode = 'wb')
...
## e.g. "CEU, Budapest, Hungary" or "central european university, vienna"
...
mds
## NOTE Lyons (plural due to English spelling) instead of Lyon
